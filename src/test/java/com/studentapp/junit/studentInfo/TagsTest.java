...
public class TagsTest extends TestBase {
   ...
   /* @WithTag("studentfeature:NEGATIVE")
    ...
    @WithTag("studentfeature:POSITIVE")
    @Title("This test will verify if a status code of 200 is return for GET request")
    @Test
    ...
    @WithTag("studentfeature:NEGATIVE")
    @Title("This test will provide an error of 400 when user tries to access an invalid resource")
    @Test
